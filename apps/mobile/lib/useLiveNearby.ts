 ...
 *
 * ## The twin of `useLiveEtas`, and where it deliberately differs
 *
 * Read that file first — every argument there about writing through to the query cache, about the clock,
 * and about `enabled` applies here unchanged and is not repeated. Three things are different:
 *
