...
final class CorpusConformanceTests: XCTestCase {
    ...
    /// *this* is where the obligation actually lands: a generated Swift `enum` with four cases
    /// **throws on decode**, and one new operator bricks every installed copy of your app until
    /// Apple approves a fix.
    ///
