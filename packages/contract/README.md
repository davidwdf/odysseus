...
| `packages/core/spec/` | **15 corpora, 111 groups, 940 cases, 4 `knownDefect` rows** | Drive your XCTest/JUnit suite from these bytes. This is the domain-rule half of the port. |
