...
| `packages/core/spec/` | **16 corpora, 126 groups, 1048 cases, 3 `knownDefect` rows** | Drive your XCTest/JUnit suite from these bytes. This is the domain-rule half of the port. |
