...
| `packages/core/spec/` | **18 corpora, 135 groups, 1125 cases, 3 `knownDefect` rows** | Drive your XCTest/JUnit suite from these bytes. This is the domain-rule half of the port. |
...
| `route-detail.spec.json` | `packages/core/src/route-detail.ts` | 9 | 97 | 1 |
