...
| `packages/core/spec/` | **15 corpora, 110 groups, 931 cases, 4 `knownDefect` rows** | Drive your XCTest/JUnit suite from these bytes. This is the domain-rule half of the port. |
...
| `route-detail.spec.json` | `packages/core/src/route-detail.ts` | 6 | 71 | 2 |
