...
| `packages/core/spec/` | **19 corpora, 139 groups, 1168 cases, 3 `knownDefect` rows** | Drive your XCTest/JUnit suite from these bytes. This is the domain-rule half of the port. |
...
| `packages/i18n/generated/ios/` | 3 locales × 154 strings + 2 plural messages | `.lproj` bundles — drop in as-is; do not retype a string. |
...
| `route-detail.spec.json` | `packages/core/src/route-detail.ts` | 9 | 101 | 1 |
