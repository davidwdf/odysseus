...
| `packages/core/spec/` | **14 corpora, 106 groups, 900 cases, 4 `knownDefect` rows** | Drive your XCTest/JUnit suite from these bytes. This is the domain-rule half of the port. |
...
| `route-detail.spec.json` | `packages/core/src/route-detail.ts` | 5 | 55 | 2 |
