...
| `packages/core/spec/` | **15 corpora, 118 groups, 1006 cases, 3 `knownDefect` rows** | Drive your XCTest/JUnit suite from these bytes. This is the domain-rule half of the port. |
...
| --- | --- | --: | --: | --: |
| `eta.spec.json` | `packages/core/src/eta.ts` | 22 | 159 | — |
