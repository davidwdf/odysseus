...
| `packages/core/spec/` | **15 corpora, 113 groups, 960 cases, 4 `knownDefect` rows** | Drive your XCTest/JUnit suite from these bytes. This is the domain-rule half of the port. |
...
| `live.spec.json` | `packages/core/src/live.ts` | 17 | 197 | — |
| `mercator.spec.json` | `packages/core/src/mercator.ts` | 6 | 37 | 1 |
| `policy.spec.json` | `packages/core/src/policy.ts` | 1 | 7 | — |
| `route-detail.spec.json` | `packages/core/src/route-detail.ts` | 7 | 80 | 2 |
