...
> **Status:** work plan, **in progress — WP6-0 … WP6-5 are done and WP6-6 has started** (2026-08-03/05,
...
| **WP6-6** ⬅ in progress | Route detail: spec + port; the motion contract | Reduced-motion is asserted; the schematic's intent is declared and the web curve is *chosen*, not inherited | L |
...
| ↳ **WP6-6b** | …the **spec**, the `apps/web` **port**, the motion contract, and `app/route/` joining `check-no-derivation`'s `POLICED` list | as the row above, plus the reduced-motion assertion | M |
