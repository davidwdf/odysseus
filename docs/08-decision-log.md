...
> **Index** — all 133 decisions, in numeric order. The entries below are in the order
...
| [112](#adr-112--a-dev-page-lives-in-the-app-and-a-gate-keeps-it-out-of-the-app) | A dev page lives in the app, and a gate keeps it out of the app | Accepted |
...
- **Consequences:**
  ...
  - ⚠️ **The wording is placeholder and is the owner's call**, on the ADR-114 / ADR-122 precedent. Shipped as
    *"Last updated {time}"*, *"You're offline — showing the last times we had"*, *"Can't reach NextBus —
    retrying"*.
