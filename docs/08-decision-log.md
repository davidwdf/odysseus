...
> **Index** — all 131 decisions, in numeric order. The entries below are in the order
...
| [030](#adr-030--route-view-as-a-vertical-schematic-line-strip-with-two-state-bus-tokens) | Route view as a vertical schematic line-strip with two-state bus tokens | Amended by ADR-033 |
...
- **Status:** **Amended by ADR-033** — **Implemented** for KMB/LWB (verified end-to-end in-browser against live data). Built on the
