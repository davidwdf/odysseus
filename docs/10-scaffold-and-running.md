...
### The one upstream fact the build does *not* fetch — GMB regions ([ADR-174](./08-decision-log.md#adr-174--a-green-minibus-route-number-needs-its-region-and-the-region-is-a-committed-table))
